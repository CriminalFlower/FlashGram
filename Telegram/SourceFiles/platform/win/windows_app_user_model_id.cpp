...
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"FlashGram.FlashGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"FlashGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"FlashGram/FlashGram.lnk"_q;
	const auto old = u"FlashGram/FlashGram (Portable).lnk"_q;
